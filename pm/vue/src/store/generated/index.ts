...
import SupsiDacdIsaacCosmosAppsSupsidacdisaacPmPm from './supsi-dacd-isaac/cosmos-apps/supsidacdisaac.pm.pm'
...
export default { 
  ...
  SupsiDacdIsaacCosmosAppsSupsidacdisaacPmPm: load(SupsiDacdIsaacCosmosAppsSupsidacdisaacPmPm, 'supsidacdisaac.pm.pm'),
